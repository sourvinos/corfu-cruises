...
export class NationalityListComponent {

    //#region variables

    private baseUrl = '/nationalities'
    private localStorageSearchTerm = 'searchTermNationality'
    private ngUnsubscribe = new Subject<void>()
    private records: Nationality[] = []
    private resolver = 'nationalityList'
    private unlisten: Unlisten
    private windowTitle = 'Nationalitys'
    public feature = 'nationalityList'
    public filteredRecords: Nationality[] = []

...
import { ShipRoute } from '../classes/shipRoute'
import { ShipRouteService } from '../classes/shipRoute.service'
...
export class ShipRouteFormComponent {
    ...
    public onSave(): void {
        if (this.form.value.id === 0) {
            this.shipRouteService.add(this.form.value).subscribe(() => {
                this.resetForm()
                this.onGoBack()
            ...
            this.shipRouteService.update(this.form.value.id, this.form.value).subscribe(() => {
    ...
    private populateFields(result: ShipRoute): void {
        this.form.setValue({
            id: result.id,

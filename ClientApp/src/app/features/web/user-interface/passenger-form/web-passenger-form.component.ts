...
@Component({
    selector: 'web-passenger-form',
    templateUrl: './web-passenger-form.component.html',
    styleUrls: ['../../../../../assets/styles/forms.css', './web-passenger-form.component.css'],
    animations: [slideFromLeft, slideFromRight]
})

export class WebPassengerFormComponent {

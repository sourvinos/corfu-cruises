...
export class BookingListComponent {
    ...
    private filterByCriteria(): void {
        this.queryResultClone.rsvs = this.queryResult.rsvs
    ...
    private updateTotals(): void {
        ...
        this.totals[1].sum = this.queryResultClone.rsvs.reduce((sum: number, array: { totalPersons: number }) => sum + array.totalPersons, 0)

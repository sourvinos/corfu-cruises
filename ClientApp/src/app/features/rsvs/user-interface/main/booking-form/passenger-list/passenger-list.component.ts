...
import { RsvPassenger } from './../../../../classes/booking-detail'
...
export class PassengerListComponent {
    ...
    headers = ['', 'rsvId', 'Id', 'headerLastname', 'headerFirstname', 'headerNationalityId', 'headerNationalityDescription', 'headerGenderId', 'headerGenderDescription', 'headerDoB', 'headerIsCheckedIn', '', '']
    ...
    types = ['', '', '', '', '', '', '', '', '', 'date', '', 'trash', '']
    fields = ['', 'rsvId', 'id', 'lastname', 'firstname', 'nationalityId', 'nationalityDescription', 'genderId', 'genderDescription', 'dob', 'isCheckedIn', '', '']

    //#endregion

    @Input() rsvId: number
    @Input() passengers: RsvPassenger[] = []
    ...
    private showPassengerForm(bookingDetail?: any): void {
        ...
        if (bookingDetail != undefined) {
            ...
            dialog.afterClosed().subscribe((result: any) => {
                if (result) {
                    bookingDetail = this.passengers.find(({ id }) => id === result.id)

...
import { BookingFlat } from './booking-flat'
...
export class BookingPdfService {
    ...
    public createReport(bookings: any[], drivers: any[], date: string): void {
        const array = this.sort(bookings)
    ...
    private sort(array: BookingFlat[]): any {

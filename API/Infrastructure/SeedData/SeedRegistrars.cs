        ...
        public static void SeedRegistrars(AppDbContext context) {
            if (!context.Registrars.Any()) {
                List<Registrar> registrars = new() {
                    ...
                    new Registrar { Id = 2, ShipId = 1, Fullname = "JOANA NAKAMURA", Phones = "582-333-3698", Email = "JUSTYN9@GMAIL.COM", Fax = "", Address = "37287 PARIS HAVEN, SUITE 316, 97656-6075, GOTTLIEBCHESTER", IsPrimary = true, IsActive = true, UserId = "e7e014fd-5608-4936-866e-ec11fc8c16da" },
                    new Registrar { Id = 3, ShipId = 1, Fullname = "BRENLEY BOATRIGHT", Phones = "234-880-3925", Email = "XANDER1@YAHOO.COM", Fax = "", Address = "76476 HELENA HARBOR, SUITE 070, 69615, ALEXANDRINEVIEW", IsPrimary = false, IsActive = true, UserId = "e7e014fd-5608-4936-866e-ec11fc8c16da" },

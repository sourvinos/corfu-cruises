...
namespace API.Features.Invoicing.Printer {
    ...
    public class InvoicingPrinterController : Controller {
        ...
        public async Task<IActionResult> CreateReport([FromBody] InvoicingPrinterCriteria criteria) {
            return await CreatePDF(repo.Get(criteria));
        }
        ...
        private async Task<IActionResult> CreatePDF(InvoicingPrinterVM report) {

...
namespace API.IntegrationTests.Routes {
    ...
    public class Routes05Put : IClassFixture<AppSettingsFixture> {
        ...
        [Theory]
        [ClassData(typeof(UpdateValidRoute))]
        public async Task Active_Simple_Users_Can_Not_Update(TestRoute record) {
            // arrange
        ...
        [Theory]
        [ClassData(typeof(UpdateInvalidRoute))]
        public async Task Active_Admins_Can_Not_Update_When_Invalid(TestRoute record) {
            // arrange

...
namespace API.IntegrationTests.Occupants {
    ...
    [Collection("Sequence")]
    public class Occupants06Delete : IClassFixture<AppSettingsFixture> {
        ...
        private readonly string _notFoundUrl = "/occupants/999";
        private readonly string _notInUseUrl = "/occupants/3";

        #endregion

        public Occupants06Delete(AppSettingsFixture appsettings) {
        ...
        public async Task Unauthorized_Not_Logged_In() {
            // act
            var actionResponse = await _httpClient.DeleteAsync(_baseUrl + "/occupants/4");
            // assert

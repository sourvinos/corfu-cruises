...
using API.IntegrationTests.Ships.Base;
using Microsoft.AspNetCore.Authentication.JwtBearer;
using Xunit;

namespace API.IntegrationTests.Ships.Owners {

    public class Owners05Put : IClassFixture<AppSettingsFixture> {
        ...
        public Owners05Put(AppSettingsFixture appsettings) {
        ...
        [Theory]
        [ClassData(typeof(ExistingOwner))]
        ...
        [Theory]
        [ClassData(typeof(ExistingOwner))]
        public async Task Simple_Users_Can_Not_Update(TestOwner record) {
            // arrange
        ...
        [Theory]
        [ClassData(typeof(ExistingOwner))]
        public async Task Admins_Can_Update(TestOwner record) {
            // arrange

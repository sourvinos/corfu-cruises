...
namespace API.IntegrationTests.Ships.Owners {
    ...
    public class Owners03GetById : IClassFixture<AppSettingsFixture> {
        ...
        public Owners03GetById(AppSettingsFixture appsettings) {
        ...
        public async Task Unauthorized_Not_Logged_In() {
            // act
            var actionResponse = await _httpClient.GetAsync(_baseUrl + "/shipOwners/1");
            // assert

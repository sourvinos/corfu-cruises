        ...
        public static void SeedCustomers(AppDbContext context) {
            if (!context.Customers.Any()) {
                List<Customer> customers = new() {
                    ...
                    new Customer { Id = 02, Description = "FEIL, KILBACK AND HALEY", Profession = "NUCLEAR POWER REACTOR OPERATOR", Address = "03479 NOLAN PIKE, APT. 426, 51929-4205, LAKE GERARDO", Phones = "406-933-0135", PersonInCharge = "DION", Email = "ITZEL_CONN@HOTMAIL.COM", IsActive = true, UserId = "e7e014fd-5608-4936-866e-ec11fc8c16da" },
                    new Customer { Id = 03, Description = "BEER INC", Profession = "SAFE REPAIRER", Address = "9337 ROLFSON MANORS, SUITE 765, 74420, PORT MYRONSHIRE", Phones = "582-282-1230", PersonInCharge = "PAYTON", Email = "BROOKLYN.BERNHARD9@YAHOO.COM", IsActive = true, UserId = "e7e014fd-5608-4936-866e-ec11fc8c16da" },
                    new Customer { Id = 04, Description = "HAGENES INC", Profession = "LOCKER ROOM ATTENDANT", Address = "0426 PFANNERSTILL LIGHTS, APT. 695, 74155, GLENDABOROUGH", Phones = "582-282-1230", PersonInCharge = "PAIGE", Email = "POLLY_SHANAHAN@GMAIL.COM", IsActive = true, UserId = "e7e014fd-5608-4936-866e-ec11fc8c16da" },
                    new Customer { Id = 05, Description = "BARTELL, PFEFFER AND JACOBI", Profession = "CLEANER", Address = "05106 AUER MISSION, SUITE 635, 40457, LAKE FATIMA", Phones = "214-695-9090", PersonInCharge = "ESTELLA", Email = "NEOMA11@GMAIL.COM", IsActive = true, UserId = "e7e014fd-5608-4936-866e-ec11fc8c16da" },
                    ...
                    new Customer { Id = 07, Description = "GREEN - PREDOVIC", Profession = "MANICURIST", Address = "700 LINDGREN OVAL, SUITE 216, 47450-2634, ANNAMARIETON", Phones = "213-530-3580", PersonInCharge = "KIRK", Email = "LENNIE_KUVALIS@YAHOO.COM", IsActive = true, UserId = "544c9930-ad76-4aa9-bb1c-8dd193508e05" },
                    new Customer { Id = 08, Description = "GREEN - HAND", Profession = "HEAT TREATING EQUIPMENT SETTER", Address = "9182 ROXANE LANDING, SUITE 564, 62630-4595, LAKE RASHAWN", Phones = "214-568-7608", PersonInCharge = "BURNICE", Email = "JANESSA95@HOTMAIL.COM", IsActive = true, UserId = "e7e014fd-5608-4936-866e-ec11fc8c16da" },
                    ...
                    new Customer { Id = 13, Description = "CROOKS INCMANN - TRANTOW", Profession = "TEAM ASSEMBLER", Address = "99649 MADELINE WALK, APT. 371, 85445-5635, ANTONETTABOROUGH", Phones = "582-282-0704", PersonInCharge = "LINNEA", Email = "BROCK37@HOTMAIL.COM", IsActive = true, UserId = "544c9930-ad76-4aa9-bb1c-8dd193508e05" },
                    new Customer { Id = 14, Description = "BEIER GROUP", Profession = "LOCKSMITH", Address = "571 LINDSEY ISLAND, APT. 220, 91380-5078, NORTH GAY", Phones = "582-333-3698", PersonInCharge = "BOBBIE", Email = "DUNCAN.OCONNELL44@YAHOO.COM", IsActive = true, UserId = "e7e014fd-5608-4936-866e-ec11fc8c16da" },
                    ...
                    new Customer { Id = 17, Description = "BARROWS, KOHLER AND WEISSNAT", Profession = "SALES MANAGER", Address = "37287 PARIS HAVEN, SUITE 316, 97656-6075, GOTTLIEBCHESTER", Phones = "214-695-9090", PersonInCharge = "GILES", Email = "JOHNNY.LABADIE65@HOTMAIL.COM", IsActive = true, UserId = "e7e014fd-5608-4936-866e-ec11fc8c16da" },
                    ...
                    new Customer { Id = 20, Description = "GREEN - HAND", Profession = "HOME MANAGEMENT ADVISOR", Address = "0426 PFANNERSTILL LIGHTS, APT. 695, 74155, GLENDABOROUGH", Phones = "248-462-6749", PersonInCharge = "LAUREL", Email = "KATTIE.GLOVER76@GMAIL.COM", IsActive = false, UserId = "e7e014fd-5608-4936-866e-ec11fc8c16da" }
                };

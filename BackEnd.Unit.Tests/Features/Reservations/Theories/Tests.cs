...
namespace BackEnd.UnitTests.Reservations {
    ...
    public class ReservationTests : IClassFixture<AppSettingsFixture> {
        ...
        [Theory]
        [ClassData(typeof(ValidateRemarks))]
        ...
        [Theory]
        [ClassData(typeof(ValidateTicketNo))]
        ...
        [Theory]
        [ClassData(typeof(ValidateCustomerId))]
        ...
        [Theory]
        [ClassData(typeof(ValidateDestinationId))]
        ...
        [Theory]
        [ClassData(typeof(ValidatePickupPointId))]
        ...
        [Theory]
        [ClassData(typeof(ValidatePortId))]

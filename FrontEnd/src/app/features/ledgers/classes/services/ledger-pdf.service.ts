...
export class LedgerPDFService {
    ...
    private addReservationsTotals(customer: LedgerVM): any {
        const row = [
            ...
            { text: this.formatZeroAsEmpty(this.calculateBodyTotals('totalPersons', customer.reservations)), alignment: 'right', fillColor: '#deecf5' },
    ...
    private addPortPerTransferTotals(hasTransfer: HasTransferGroupVM): any {
        const row = [
            ...
            { text: this.formatZeroAsEmpty(hasTransfer.totalPersons), alignment: 'right', border: [true, true, true, true] },
            { text: this.formatZeroAsEmpty(hasTransfer.totalPassengers), alignment: 'right', border: [true, true, true, true] },
            { text: this.formatZeroAsEmpty(hasTransfer.totalPersons - hasTransfer.totalPassengers), alignment: 'right', border: [true, true, true, true] },
